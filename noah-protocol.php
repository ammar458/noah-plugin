...
function noah_boot(): void {
    ...
    require_once NOAH_PATH . 'includes/stripe/class-noah-stripe-import-sync.php';
    ...
    require_once NOAH_PATH . 'includes/emails/class-noah-emails.php';
